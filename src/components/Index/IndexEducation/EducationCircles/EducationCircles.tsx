import {FC, useEffect, memo, useCallback, useState, PureComponent, ContextType} from 'react'
...
import {AppContext, useAuthContext} from '@/ctx/auth'
...
//   const [isRerender, changeRender] = useState<boolean>(false)
//
...
//
//   useEffect(() => {
//     if (skillList?.length && !isRerender) {
//       draw()
//       changeRender(true)
//     }
//   }, [skillList, draw, isRerender])
//
//   return (
//     <div className="education-circles">
//       <svg id="circleCanvas"/>
